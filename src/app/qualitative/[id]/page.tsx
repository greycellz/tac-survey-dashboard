...
import { ResearcherNotesPanel } from "../_components/ResearcherNotesPanel";
import { ResearcherSummaryBanner } from "../_components/ResearcherSummaryBanner";
...
function ParticipantTranscriptInner() {
  ...
  return (
    <div className="max-w-7xl mx-auto">
      ...
      <ResearcherSummaryBanner participantId={id} />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_22rem] gap-6">
        ...
        <aside className="lg:sticky lg:top-6 lg:self-start lg:max-h-[calc(100vh-3rem)] lg:overflow-y-auto border border-neutral-200 rounded-md bg-white">
          <ResearcherNotesPanel participantId={id} />
              ...
              return (
                ...
                >
                  <div className="flex flex-wrap items-center gap-1 mb-1">
                    {q.source === "uncoded" ? (
                      <span className="text-[10px] px-1.5 py-0.5 rounded bg-amber-100 text-amber-900">Uncoded</span>
                    ) : (
                      q.codes.map((c) => (
